...
<body>
    ...
    ?>
        ...
        $countQuery = "SELECT COUNT(c.login) AS client_count FROM sis_cliente c WHERE c.parc_abertas = 0 AND c.cli_ativado = 's' AND c.tipo_cob LIKE 'carne' AND c.isento LIKE 'nao'";
        ...
        echo "<div class='client-count-container'><p class='client-count blue'>Quantidade de clientes sem Carne: $clientCount</p></div>";
        } else {
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    ...
                    $query = "SELECT c.uuid_cliente, c.nome, MAX(l.datapag) AS datapag
                    FROM sis_cliente c
                    LEFT JOIN sis_lanc l ON c.login = l.login
                    WHERE c.parc_abertas = 0 AND c.cli_ativado = 's' AND c.tipo_cob LIKE 'carne' AND c.isento LIKE 'nao'"
                    . $searchCondition .
